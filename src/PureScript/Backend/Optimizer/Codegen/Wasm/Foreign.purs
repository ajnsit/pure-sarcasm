module PureScript.Backend.Optimizer.Codegen.Wasm.Foreign where
...
wasmForeignSemantics :: Map (Qualified Ident) ForeignEval
wasmForeignSemantics = Map.fromFoldable
